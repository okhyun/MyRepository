...
<html>
				...
				$.ajax({
					...
					success: function(data) {
						...
						for(var i=0; i<data.length; i++) {
						    html +=				'<div style="width:120px; height:130px; display:inline-block; margin:5px;  background-image:url( '+ data[i].aimg +');  background-size: 120px 130px;">';
							html +=					'<div>';
	...
	<body>
		...
		<div id="div1" style="height:500px; border:1px solid black" ></div>
