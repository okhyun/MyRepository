...
insert into member values('user2', '사용자1', 200, '여자', 'user2@sw.com', sysdate);
insert into member values('user3', '사용자1', null, null, 'user2@sw.com', sysdate);
insert into member values('user4', '사용자1', 30, '중성', 'user2@sw.com', sysdate);


--Section09 DEFAILT 제약조건
drop table board;
create table board (
bno number(10) primary key,
btitle varchar(100) not null,
...
insert into board values(2, '제목1', '내용1', 'user1', default, default, sysdate);
...
mage varchar(10) constraint ch_member_mid check(mage>=0 and mage<150)
);
